...
architecture arch_imp of axis_slave is
...
begin
  ...
  axis_tready <= '1' when ((mst_exec_state = WRITE_FIFO) and (write_pointer <= NUMBER_OF_INPUT_WORDS-1) and (fifo_full_flag = '0')) else '0';
